...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYMBOL] = LAYOUT(
    ...
    _______, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC,  KC_GRAVE,   KC_MINS,   KC_AMPR, KC_EQUAL,  KC_COMM,  KC_DOT, KC_RSHIFT,
                                MO(FNCT), KC_SPACE, KC_ESC,   KC_ENTER, KC_SPACE, KC_RALT
  ),
  [FNCT] = LAYOUT(
    KC_F1 ,   KC_F2,    KC_F3,    KC_F4,  KC_F5,     KC_F6,   KC_F7,       KC_F8,    KC_F9,   KC_F10,  KC_F11,  KC_F12,
    _______, KC_LALT,  KC_LWIN,  KC_LSFT,  KC_RCTL, KC_RALT,   KC_PGUP,   KC_HOME,    KC_UP,   KC_END,  _______,  _______, 
    _______,  _______,   _______,   _______,   _______,  _______,   KC_PGDN,   KC_LEFT,  KC_DOWN,  KC_RGHT,  _______,  _______,
                                 _______, KC_SPACE,  KC_ESC,   KC_ENTER, KC_SPACE,   _______
  )
};
